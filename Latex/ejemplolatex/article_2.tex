...
\usepackage{graphicx} % Copypasted from google to use images
...
\fancyhead[C]{Jornal de la Cencia $\bullet$ Enero de 1352 $\bullet$ Vol. XXX, No. 007} % Custom header text
...
\title{Distribución estocástica de forúnculos leprosoides en poblaciones sublumínicas de percebes árticos} % Article title
\author{%
\textsc{Gerardo de Revilla y su caballo Sardinilla}\thanks{También conocido como el Brujero} \\[1ex] % Your name
\normalsize University of the Street \\ % Your institution
...
\noindent Hola! Soy el astracto. Me dicen así por mi bellesa, que es un ronpekabesa. Tututuututu
dalsjflaskjfh
asdfasdfasfasf
asdfasdfasf
\end{abstract}
